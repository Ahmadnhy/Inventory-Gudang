					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<?php 
			                    ...
			                    $sql = "SELECT * FROM users WHERE id LIKE '%$cari%' OR kode LIKE '%$cari%' OR nama LIKE '%$cari%' OR email LIKE '%$cari%' OR telepon LIKE '%$cari%' OR alamat LIKE '%$cari%' OR level LIKE '%$cari%'";
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='user.php' class="right waves-effect waves-light btn black darken-2">KEMBALI</a>
				            	</td>
				            </tr>
						</table>
					</div>

		                ...
		                <li>
		                	...
		                	<div class="collapsible-body">
		                		<ul>
									...
									<li class="active black darken-4"><a href="barangmasuk.php">Barang Masuk</a></li>
				...
				<div class="col s12 m12 l12 offset-l2"> <br>
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='tambah-barang-masuk.php' class="right waves-effect waves-light btn black darken-2">Tambah Barang<i class="material-icons right">add</i></a>
				            	</td>
				            </tr>
						</table>
					</div>
